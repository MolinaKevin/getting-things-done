...
Item {
    signal listUpdated()
    signal projectTabReady(var reference)
    ...
    function updateList() {
        var data = databaseService.loadProjects(); 
        listModel.clear(); 
    ...
    function addProject(name,details) {
        databaseService.addProject(name,details);
    }

    Component.onCompleted: {
        projectTabReady(this);
    }
    ...
    LomiriListView {
        ...
        delegate: ListItemWithLabel {
            ...
            ColumnLayout {
                ...
                Text {
                    text: "Descripción: " + model.description
                }
        ...
        ConfirmDialog {
            ...
            Column {
                ...
                TextField {
                    width: parent.width
                    id: newProjectInput
                    placeholderText: qsTr("Nombre del proyecto")
                }

                TextField {
                    width: parent.width
                    id: newProjectDesc
                    placeholderText: qsTr("Detalles del proyecto")
                }
                Row {
                    id: row
                    width: parent.width
                    ...
                    Button {
                        ...
                        color: LomiriColors.green
                        onClicked: {
                            if (newProjectInput.text != "") {
                                addProject(newProjectInput.text, newProjectDesc.text);
                                updateList();
                            }
                            PopupUtils.close(confirmDialog)
                        }
